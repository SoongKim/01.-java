			...
			if (menuSelect.equals("1")) {
				...
				if (menuSelect2.equals("2")) {
					...
					if (classroom.student[Integer.parseInt(studentNum)].name == null) {
						...
						System.out.println("해당 학생의 이름 : " + classroom.student[stuNum].name + " | 해당 학생의 거주지역 : " + classroom.student[stuNum].address + " | 해당 학생의 성별 : " + classroom.student[stuNum].gender+"성");
						System.out.println();
					}
					...
					if (Integer.parseInt(selUser) < 100 && Integer.parseInt(selUser) >= 0) {
						...
						if (selUser3.equals("1")) {
							if (classroom.student[selUser2].test[0] == null) {
								...
								System.out.println("1학기 중간고사 국어 성적은 : " + classroom.student[selUser2].test[0].korScore + "점");
								System.out.println("1학기 중간고사 영어 성적은 : " + classroom.student[selUser2].test[0].engScore + "점");
								System.out.println("1학기 중간고사 수학 성적은 : " + classroom.student[selUser2].test[0].mathScore+ "점");
							}
						} else if (selUser3.equals("2")) {
							if (classroom.student[selUser2].test[1] == null) {
								System.out.println("아직 입력하지 않은 성적 정보를 조회하셨습니다.");
							} else {
								System.out.println("1학기 기말고사 국어 성적은 : " + classroom.student[selUser2].test[1].korScore + "점");
								System.out.println("1학기 기말고사 영어 성적은 : " + classroom.student[selUser2].test[1].engScore + "점");
								System.out.println("1학기 기말고사 수학 성적은 : " + classroom.student[selUser2].test[1].mathScore + "점");
							}
						} else if (selUser3.equals("3")) {
							if (classroom.student[selUser2].test[0].korScore == 0) {
								System.out.println("아직 입력되지 않은 성적 정보를 조회하셨습니다.");
							} else {
								System.out.println("2학기 중간고사 국어 성적은 : " + classroom.student[selUser2].test[2].korScore + "점");
								System.out.println("2학기 중간고사 영어 성적은 : " + classroom.student[selUser2].test[2].engScore + "점");
								System.out.println("2학기 중간고사 수학 성적은 : " + classroom.student[selUser2].test[2].mathScore + "점");
							}
						} else if (selUser3.equals("4")) {
							if (classroom.student[selUser2].test[0].korScore == 0) {
								System.out.println("아직 입력되지 않은 성적 정보를 조회하셨습니다.");
							} else {
								System.out.println("2학기 기말고사 국어 성적은 : " + classroom.student[selUser2].test[3].korScore + "점");
								System.out.println("2학기 기말고사 영어 성적은 : " + classroom.student[selUser2].test[3].engScore + "점");
								System.out.println("1학기 기말고사 수학 성적은 : " + classroom.student[selUser2].test[3].mathScore + "점");
							}
						} else {
				...
				if(userSelect.equals("1")){
					...
					System.out.println("국어 점수 총합 : " + kor1 +"점 | 영어 점수 총합 : " + eng1 + "점 | 수학 점수 총합 : " + math1 +"점");
					System.out.println("국어 점수 평균 : " + (double)kor1 / (double)index1 + "점 | 영어 점수 평균 : " + (double)eng1 / (double)index1 + "점 | 수학 점수 평균 : "+(double)math1 / (double)index1);
				}
					...
					System.out.println("국어 점수 총합 : " + kor2 +"점 | 영어 점수 총합 : " + eng2 + "점 | 수학 점수 총합 : " + math2 +"점");
					System.out.println("국어 점수 평균 : " + (double)kor2 / (double)index2 + "점 | 영어 점수 평균 : " + (double)eng2 / (double)index2 + "점 | 수학 점수 평균 : "+(double)math2 / (double)index2);
				}
					...
					System.out.println("국어 점수 총합 : " + kor3 +"점 | 영어 점수 총합 : " + eng3 + "점 | 수학 점수 총합 : " + math3 +"점");
					System.out.println("국어 점수 평균 : " + (double)kor3 / (double)index3 + "점 | 영어 점수 평균 : " + (double)eng3 / (double)index3 + "점 | 수학 점수 평균 : "+(double)math3 / (double)index3);
				}
					...
					System.out.println("국어 점수 총합 : " + kor4 +"점 | 영어 점수 총합 : " + eng4 + "점 | 수학 점수 총합 : " + math4 +"점");
					System.out.println("국어 점수 평균 : " + (double)kor4 / (double)index4 + "점 | 영어 점수 평균 : " + (double)eng4 / (double)index4 + "점 | 수학 점수 평균 : "+(double)math4 / (double)index4);
				}
				else {
					System.out.println("올바른 값을 입력해주세요.");
				}
