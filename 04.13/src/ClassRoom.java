	...
	public static void main(String[] args) {
		...
		for (int j = 0; j < 999999; j++) {
			...
			if (menuSel.equals("1")) {
				...
				System.out.println(userNums + "번 학생이 취득한 국어 총 점수는 " + korscore);
				System.out.println(userNums + "번 학생이 취득한 영어 총 점수는 " + engscore);
				System.out.println(userNums + "번 학생이 취득한 수학 총 점수는 " + mathscore);
